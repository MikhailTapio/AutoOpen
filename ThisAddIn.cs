 ...
 * 作者：20信息管理-YYH
 **/
namespace AutoOpen_Excel
{
    public partial class ThisAddIn
    {
        private static readonly DateTime Jan1st1970 = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        private const string openedName = "OpenedWorkbooks.txt";
        ...
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            if (File.Exists(openedTemp))
            {
                ...
                foreach (var entry in map)
                {
                    ...
                    if (lastClosed - entry.Value < 30000L) Application.Workbooks.Open(entry.Key);
                }
        ...
        {
            closed.Add(Wb.FullName, CurrentTimeMillis());
        }
